...
public class NotificationService extends IntentService {
    public static final String MUSIC_DOWNLOAD_ACTION = "free.mp3.test.util.download";
    public static final String MUSIC_DOWNLOAD_PATH = "free.mp3.test.util.path";
